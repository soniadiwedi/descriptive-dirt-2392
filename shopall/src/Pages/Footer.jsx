...
export default function Footers() {
  return (
    ...
    >
      <Container as={Stack} maxW={"6xl"} py={7}>
        <SimpleGrid
        ...
        >
          <Stack spacing={6}>
            <Box>
              <Heading fontSize="20px">Join ShopAll Family</Heading>
            </Box>
            <Text fontSize={"sm"}>
              Enjoy guaranteed discounts, special previews, food offers and much
              more. Sign up today - it’s free and only takes a minute to join.
            </Text>
            <Button
            ...
            <Box>
              <Heading fontSize="20px">ShopAll for Business</Heading>
            </Box>
            <Text fontSize={"sm"}>
              Our business & design experts help you with flexible, affordable
              and sustainable solutions. Create a better life at work with us.
            </Text>
            <Button
            w={"40%"}
              bg={"black"}
          ...
          <Stack align={"flex-start"}>
            <ListHeader>ShopAll</ListHeader>
            <Link href={"#"}>Log in</Link>
            <Link href={"#"}>Join ShopAll Family</Link>
            <Link href={"#"}>Member offers</Link>
            <Link href={"#"}>Workshop & Events </Link>
          </Stack>
          <Stack align={"flex-start"}>
            <ListHeader>Services</ListHeader>
            <Link href={"#"}>Design your room</Link>
            <Link href={"#"}>Delivery Service</Link>
            <Link href={"#"}>Installation Service</Link>
            <Link href={"#"}>Assembly Service</Link>
            <Link href={"#"}>Kitchen Planning</Link>
            <Link href={"#"}>Measuring Service</Link>
            <Link href={"#"}>Customer Service</Link>
            <Link href={"#"}>Recycle Program</Link>
          ...
          <Stack align={"flex-start"}>
            ...
            <Link href={"#"}>Prices and price tags</Link>
            <Link href={"#"}>Contact us</Link>
            <Link href={"#"}>FAQ's</Link>
            <Link href={"#"}>Planners</Link>
            <Link href={"#"}>Size guide - Beds & mattresses</Link>
            <Link href={"#"}>Buying guides</Link>
            <Link href={"#"}>Gift Cards</Link>
            <Link href={"#"}>Feedback</Link>
          </Stack>
          <Stack align={"flex-start"}>
            <ListHeader>About ShopAll</ListHeader>
            <Link href={"#"}>This is ShopAll</Link>
            <Link href={"#"}>Working at ShopAll</Link>
            <Link href={"#"}>Newsroom</Link>
            <Link href={"#"}>Sustainability</Link>
            <Link href={"#"}>shoAll Stores</Link>
            <Link href={"#"}>ShopAll Restaurant</Link>
            <Link href={"#"}>ShopAll for Business</Link>
          </Stack>
        </SimpleGrid>
      </Container>
    </Box>
